...
OpenStream Beta is focused on making the Android-to-OBS setup easier to understand and safer to upgrade. It includes the refreshed OBS source UI, V8 source naming, V7 scene compatibility, Android camera streaming, and direct install downloads for both surfaces.
...
4. Add an `OpenStream Beta Camera` source.
