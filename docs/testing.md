...
| Relaunch after Stop | The Activity binds without starting a foreground service. The service sees the persisted Stopped state and stops the inactive start request without restarting media. | Instrumentation test code added; emulator run unavailable |
